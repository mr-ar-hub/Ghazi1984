    ...
    <div class="section-mission container-fluid">
        <div class="row align-items-center">
            <div class="col-lg-6 mission-image-container">
                <img src="{{ asset('assets/images/mission-image.webp') }}" alt="Mission" class="mission-image">
            </div>
    ...
    <div class="section-vision container-fluid">
        <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2 vision-image-container">
                <img src="{{ asset('assets/images/vision-image.webp') }}" alt="Vision" class="vision-image">
            </div>
    ...
    <div class="section-team container">
        ...
        <div class="row gy-5 team-container">
            <div class="col-md-3">
                <div class="team-member">
                    <div class="team-member-image">
                        <img src="{{ asset('assets/images/team-member-1.webp') }}" alt="Team Member">
                    </div>
            ...
            <div class="col-md-3">
                <div class="team-member">
                    <div class="team-member-image">
                        <img src="{{ asset('assets/images/team-member-2.webp') }}" alt="Team Member">
                    </div>
                    <div class="team-member-info">
                        <h5>Haider Ali</h5>
            ...
            <div class="col-md-3">
                <div class="team-member">
                    <div class="team-member-image">
                        <img src="{{ asset('assets/images/team-member-3.webp') }}" alt="Team Member">
                    </div>
                    <div class="team-member-info">
