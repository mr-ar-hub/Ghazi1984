        ...
        <div class="container">
            <header class="entry-header">
                ...
                <div class="breadcrumbs">
                    <a href="{{ route('index') }}">Home</a> » <span class="current">Search Products</span>
                </div>
            </header>
        </div>
    </div>
                ...
                <div class="price-range-filter">
                    ...
                    <form action="{{ route('productsFilter') }}" method="GET">
                        ...
                        <div class="price_slider_wrapper">
                            <input type="range" class="form-control-range" id="priceRange" min="0" max="{{ $maxPriceFromDb }}" step="100">
