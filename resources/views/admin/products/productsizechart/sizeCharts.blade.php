            ...
            <div class="card-header">
                <div class="card-title" style="width: 100%; display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div style="margin-left: auto;">
                        <a href="{{ route('addProductSizeChart') }}" class="btn btn-primary btn-sm">
                ...
                <table id="myDataTable" class="table table-hover table-sm table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('deleteSizeChart', ['id' => $item->id]) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
