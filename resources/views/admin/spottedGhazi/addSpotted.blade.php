        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Add New Spotted In Ghazi</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title" style="width: 100%;">
                            <h5>Add New Spotted In Ghazi <a href="" class="btn btn-primary btn-sm float-right"><i class="fas fa-arrow-left"></i> Back</a></h5>
                        </div>  
                    </div>
                    <div class="card-body">
                        <form action="{{ route('uploadSpotted') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label>Spotted Name</label>
                                <input type="text" name="name" placeholder="Spotted Name" class="form-control">
                            </div>
                            <div class="form-group col-6" id="spotted_images">
                                <input type="hidden" id="spotted_id">
                                <label for="carousel">Add Spotted Image</label>
                            ...
                            <div class="row">
                                <div class="col-sm-12 mt-2">
                                    ...
                                    <a href="{{ route('uploadSpotted') }}" class="btn btn-danger" style="float: right; padding: 5px 50px;">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
