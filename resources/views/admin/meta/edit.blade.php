                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title" style="width: 100%;">
                            <h5>Edit Metakeywords <a href="{{ route('metakeywords') }}" class="btn btn-primary btn-sm float-right"><i class="fas fa-arrow-left"></i> Back</a></h5>
                        </div>  
                    </div>
                    <div class="card-body">
                        <form action="{{route('updateMetakeywords' , $data->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <input name="keywords" placeholder="Enter Keywords" value="{{ old('keywords', $formattedKeywords) }}" class="form-control" id="keywords-input" />
