        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Add New Carousel Image</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title" style="width: 100%;">
                            <h5>Add New Carousel Image <a href="{{ route('carouselImages') }}" class="btn btn-primary btn-sm float-right"><i class="fas fa-arrow-left"></i> Back</a></h5>
                        </div>  
                    </div>
                    <div class="card-body">
                        <div class="form-group" id="carousel_images">
                            <input type="hidden" id="carousel_id">
                            <label for="carousel">Add Carousel Image</label>
                        ...
                        <div class="row">
                            <div class="col-sm-12 mt-2">
                                <a href="{{ route('addNewImage') }}" class="btn btn-danger" style="float: right; padding: 5px 50px;">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">    
        ...
        init: function() {
            ...
            this.on('removedfile', function(file) {
                if (file.meta_data) {
                    ...
                    deleteCarouselImage(file.meta_data);
    ...
    function deleteCarouselImage(id) {
        $.ajax({
            type: "GET",
            url: "{{ route('deletecarouselImage', ['id' => ':id']) }}".replace(':id', id),
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
        });
