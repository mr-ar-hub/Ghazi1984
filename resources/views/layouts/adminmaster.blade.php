...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('/adminassets/dist/css/style.css') }}">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
     ...
     <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <a href="{{ route('admin.dashboard') }}" class="brand-link">
        <img src="{{ asset('adminassets/dist/img/'.Auth::user()->photo) }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column mb-5" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                ...
                <li class="nav-item">
                  <a href="{{ route('metakeywords') }}" class="nav-link">
                    <i class="nav-icon fas fa-newspaper"></i>
                    <p>
                       Meta Keywords
                    </p>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                <li class="nav-item">
                  <a href="{{ route('facebookPixcel', ['id' => 1]) }}" class="nav-link">
                ...
                <li class="nav-item">
                  <a href="{{route('socialLinks')}}" class="nav-link">
                    <i class="nav-icon fa-solid fa-square-share-nodes"></i>
                      <p>
                        Social Links
                      </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('credentialpage') }}" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" style="display: none;">
                ...
                <li class="nav-item">
                  <a href="{{ route('productSizeChart') }}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{ route('bankDetail') }}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{ route('carouselImages') }}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{ route('indexbulkOrder') }}" class="nav-link">
                <i class="nav-icon fas fa-paste"></i>
                  <p>
                    ...
                    @endphp
                    <span class="badge badge-info right">{{ $bulkOrder }}</span>
                  </p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('indexbulkSurvingOrder') }}" class="nav-link">
                <i class="nav-icon fas fa-box-open"></i>
                <p>
                  Bulk Serving Record
                </p>
            ...
            <li class="nav-item">
              <a href="{{ route('spottedGhazi') }}" class="nav-link">
                <i class="nav-icon fas fa-sliders-h"></i>
                <p>
                  Spotted in Ghazi
                </p>
            ...
            <li class="nav-item">
              <a href="{{route('admincoupon')}}" class="nav-link">
...
<script src="{{ asset('/adminassets/dist/js/jquery-editable-poshytip.min.js') }}"></script>
