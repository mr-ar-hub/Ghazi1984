                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title" style="width: 100%;">
                            <h5>Add Metakeywords <a href="<?php echo e(route('metakeywords')); ?>" class="btn btn-primary btn-sm float-right"><i class="fas fa-arrow-left"></i> Back</a></h5>
                        </div>  
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('uploadMetakeywords')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label>Keywords</label>
                                <div>
                                    <input name="keywords" placeholder="Enter Keywords" value="<?php echo e(old('keywords')); ?>" class="form-control" id="keywords-input" />
...
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ghazi1984/public_html/resources/views/admin/meta/create.blade.php ENDPATH**/ ?>