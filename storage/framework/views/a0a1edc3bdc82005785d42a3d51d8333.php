        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('updateBlog', ['id' => $blog->id])); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('put'); ?>
                            <div class="form-group">
                                <label>Blog title</label>
                                <input type="text" name="title" placeholder="Enter Blog Title" value="<?php echo e($blog->title); ?>"  class="form-control" />
                            </div>
                            <div class="row">
                                <div class="form-group col-6">
                                    <label>Auther Name</label>
                                        <input type="text" name="auther_name" value="<?php echo e($blog->auther_name); ?>"  class="form-control" />
                                </div>
                                <div class="form-group col-4">
                                    <label>Blog Date</label>
                                        <input type="date" name="blog_date" value="<?php echo e($blog->blog_date); ?>"  class="form-control" />
                                </div>
                                <div class="form-group col-2">
                                    <label>Feature</label>
                                    <div>
                                        <input type="checkbox" name="feature" style="width: 20px; height: 20px; margin-top: 6px;" <?php if($blog->feature): ?> checked <?php endif; ?>>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" name="short_description" value="<?php echo e($blog->short_description); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="editor1">Blog Description</label>
                                <textarea id="editor1" placeholder="Enter description of blog" name="blog_description"><?php echo e($blog->blog_description); ?></textarea>
                            </div>
                            <div class="row mt-3">
                            ...
                            <div class="row">
                                <div class="col-sm-12 mt-2">
                                    ...
                                    <a href="<?php echo e(route('updateBlog', ['id' => $blog->id])); ?>" class="btn btn-danger" style="float: right; padding: 5px 50px;">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="text/javascript">    
    ...
    const dropzone2 = new Dropzone("#blog_image", { 
        ...
        init: function() {
            ...
            var mockFile = { 
                    name: "<?php echo e($blog->BlogImage->image_name); ?>", 
                    dataURL: "<?php echo e(asset('storage/' . $blog->BlogImage->image_name)); ?>", 
                    meta_data: "<?php echo e($blog->BlogImage->id); ?>",
                    accepted: true 
                };
                ...
                $("#blog_images").append('<input type="hidden" id="blog_images_val_<?php echo e($blog->BlogImage->id); ?>" name="blog_images_val[]" value="<?php echo e($blog->BlogImage->id); ?>">');
            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ghazi1984/public_html/resources/views/admin/blogs/editBlog.blade.php ENDPATH**/ ?>