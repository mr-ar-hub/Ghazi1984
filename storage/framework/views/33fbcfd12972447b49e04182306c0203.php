        ...
        <div class="container">
            <header class="entry-header">
                ...
                <div class="breadcrumbs">
                    <a href="<?php echo e(route('index')); ?>">Home</a> » <span class="current">Wishlist</span>
                </div>
            </header>
        </div>
    </div>
            ...
            <div class="product-item">
                ...
                <div class="product-element-top">
                    <a href="#" class="product-image-link">
                        <img src="<?php echo e(asset('assets/images/product-3.webp')); ?>" alt="Product 1">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ghazi1984/public_html/resources/views/frontend/wishlist.blade.php ENDPATH**/ ?>