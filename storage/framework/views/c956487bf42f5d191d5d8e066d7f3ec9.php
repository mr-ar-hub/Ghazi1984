...
<!-- 
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="slider-for">
                    <?php $__currentLoopData = $product->CarouselImg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($index == 1): ?>
                            <?php if(isset($product->ProductImg) && isset($product->ProductImg->image_name)): ?>
                                <div>
                                    <img src="<?php echo e(asset('storage/'.$product->ProductImg->image_name)); ?>" class="img-fluid" alt="">
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                        <div class="<?php echo e($index == 0 ? 'active' : 'test'); ?>" >
                            <?php if(isset($image->image_name)): ?>
                                <img src="<?php echo e(asset('storage/'.$image->image_name)); ?>" class="img-fluid" alt="">
                            <?php endif; ?>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="slider-nav mt-2">
                    <?php $__currentLoopData = $product->CarouselImg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carouselImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <img src="<?php echo e(asset('storage/' . $carouselImage->image_name)); ?>" class="img-fluid" alt="<?php echo e($product->name); ?>">
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            <div class="col-lg-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('categories', ['id' => $product->catName->parent->id])); ?>"><?php echo e($product->catName->parent->cat_name); ?></a></li>
                        <li class="breadcrumb-item"><a href="<?php echo e(route('products', ['id' => $product->cat_id])); ?>"><?php echo e($product->catName->cat_name); ?></a></li>
                        <li class="breadcrumb-item active final-page"><?php echo e($product->name); ?></li>
                    </ol>
                </nav>
                ...
                <div class="mb-3">
                    ...
                    <div id="sizeSelect" class="d-flex flex-wrap" role="group">
                        <?php $__currentLoopData = $sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <input type="radio" class="btn-check" name="size" id="<?php echo e($sizeId); ?>" value="<?php echo e($sizeName); ?>" data-size-name="<?php echo e($sizeName); ?>">
                            <label class="btn select-size" for="<?php echo e($sizeId); ?>"><?php echo e($sizeName); ?></label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <?php if($product->stock != 0): ?>
                    <p><strong><?php echo e($product->stock); ?> In stock</strong></p>
                <?php else: ?>
                ...
                <div class="mb-3 product-detail-btns">
                    ...
                    <button><a href="<?php echo e(route('bulkOrder')); ?>" style="color: white;">Bulk Order</a></button>
                    <?php if($product->size_chart_id != 0): ?>
                        <button type="button" data-bs-toggle="modal" data-bs-target="#sizeChartModal" data-image="<?php echo e(asset('storage/' . $product->sizeChartImage->image_name)); ?>">
                            Size Chart
                        </button>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img id="sizeChartImage" src="" alt="<?php echo e($product->sizeChartImage->name); ?>" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <hr>
                <?php if($product->artical_name != null): ?>
                    <p class="article-number"><span>SKU: </span><?php echo e($product->artical_name); ?></p>
                <?php endif; ?>

                <p class="product-detail-categories">Categories:
                    <a href="<?php echo e(route('products', ['id' => $product->cat_id])); ?>"><?php echo e($product->catName->cat_name); ?></a>
                </p>
            ...
            <ul class="nav nav-tabs" id="productTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="specs-tab" data-bs-toggle="tab" data-bs-target="#specs" type="button"
                        role="tab" aria-controls="specs" aria-selected="false">Reviews (<?php echo e($totalreview); ?>)</button>
                </li>
                <li class="nav-item" role="presentation">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php if(!$totalreview == 0): ?>
                                <h2><?php echo e($totalreview); ?> Review For <?php echo e($product->name); ?></h2>
                                <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p>
                                                <strong><?php echo e($data->user_name); ?></strong> – <?php echo e($data->created_at->format('F d, Y')); ?>

                                            </p>
                                            <p class="mb-2"><?php echo e($data->review); ?></p>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="star-rating" style="float: right;">
                                                <?php for($i = 1; $i <= 5; $i++): ?>
                                                    <span class="star" style="color: <?php echo e($i <= $data->rating ? 'gold' : 'lightgray'); ?>">&#9733;</span>
                                                <?php endfor; ?>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <?php if(!$totalreview == 0): ?>
                                <h2>Add a review</h2>
                            <?php else: ?>
                                <h2>Be the first to review “<?php echo e($product->name); ?>”</h2>
                                <p>Your email address will not be published. Required fields are marked<span style="color: red;"> *</span></p>
                            <?php endif; ?>
                            <div>
                                <form action="<?php echo e(route('storeReview')); ?>" method="post" onsubmit="return validateForm()">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="product_id" value="<?php echo e($product->id); ?>">
                                    <div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" name="user_name" value="<?php echo e(old('user_name')); ?>" class="form-control" required required=""/>
                                        </div>
                                        <div class="form-group col-6">
                                            <label>E-mail&nbsp;<span style="color: red;"> *</span> :</label>
                                            <input type="text" name="user_email" value="<?php echo e(old('user_email')); ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="mt-3">
    ...
    <div id="cartSidebar" class="cart-sidebar position-fixed top-0 end-0 bg-white shadow-lg d-none"
        ...
        <div class="d-flex flex-column">
            <div class="cart-sidebar-bar d-flex justify-content-between align-items-center p-3 border-bottom">
                <div>
                    <span class="border-dark border p-1"><?php echo e(count($cart)); ?></span>
            ...
            <div class="cart-body p-3">
                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex mb-3 cart-item" data-item-id="<?php echo e($item->id); ?>">
                        <a href="<?php echo e(route('productDetail', ['id' => $items->id])); ?>">
                            <img src="<?php echo e(asset('storage/'.$item->product->ProductImg->image_name)); ?>" alt="<?php echo e($item->product->name); ?>" class="img-fluid" style="width: 120px; height: 120px">
                        </a>
                        <div class="ms-3">
                            <a href="<?php echo e(route('productDetail', ['id' => $items->id])); ?>" class="text-dark fw-bold d-block mb-1"><?php echo e($item->product->name); ?></a>
                            <p>Select Gender:</p>
                            <p><?php echo e($item->gender); ?></p>
                            <div class="mt-4">
                                <span><?php echo e($item->quantity); ?></span> X <span><?php echo e(get_currency_symbol()); ?> <?php echo e(format_price_only($item->product->price)); ?></span> = <span><?php echo e(get_currency_symbol()); ?> <?php echo e(format_price_only($item->quantity * $item->product->price)); ?></span>
                            </div>
                        </div>
            ...
            <div class="cart-footer fixed-bottom bg-light p-3">
                <div>
                    <div class="cart-price">
                        ...
                        <span class="subtotal-value"><?php echo e(get_currency_symbol()); ?> <?php echo e(format_price_only($total)); ?></span>
                    </div>
                    <div class="cart-buttons">
                        <a href="<?php echo e(route('shop')); ?>">Continue Shopping</a>
                        <a href="<?php echo e(route('cart')); ?>">View Cart</a>
                        <a href="<?php echo e(route('checkout')); ?>">Checkout - <span class=""><?php echo e(get_currency_symbol()); ?> <?php echo e(format_price_only($total)); ?></span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const sizeColorMap = <?php echo json_encode($sizeColorMap, 15, 512) ?>;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.delete-cart-item').forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    fetch('<?php echo e(route("removeFromCart")); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-Requested-With': 'XMLHttpRequest'
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ghazi1984/public_html/resources/views/frontend/productDetail.blade.php ENDPATH**/ ?>