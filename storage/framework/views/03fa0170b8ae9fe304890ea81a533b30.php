        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Spotted In Ghazi</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title" style="width: 100%;">
                    <h5>Spotted In Ghazi<a href="<?php echo e(route('addNewSpotted')); ?>" class="btn btn-primary btn-sm float-right"><i class="fa fa-plus"></i> Add Spotted</a></h5>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody id="first-body">
                        <?php $__currentLoopData = $spotted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="item-drag" data-id="<?php echo e($item->id); ?>">
                                ...
                                <td><a href="<?php echo e(route('editSpotted', ['id' => $item->id])); ?>" style="margin-top: 30px;"><?php echo e($item->name); ?></a></td>
                                <td>
                                    <?php if($item->SpottedImage): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->SpottedImage->image_name)); ?>" width="100px" height="100px" data-toggle="modal" data-target="#imagePreviewModal" data-src="<?php echo e(asset('storage/' . $item->SpottedImage->image_name)); ?>">
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <form id="status-form-<?php echo e($item->id); ?>" method="POST" action="<?php echo e(route('updateSpottedStatus', ['id' => $item->id])); ?>">
                                        <?php echo csrf_field(); ?>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-success btn-sm mt-4" href="<?php echo e(route('editSpotted', ['id' => $item->id])); ?>"><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger btn-sm mt-4" href="<?php echo e(route('deleteSpotted', ['id' => $item->id])); ?>"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr> 
...
<script>
    ...
    function updateOrderNo(currentOrderList) {
        $.ajax({
            type: 'POST',
            url: "<?php echo e(route('updateSpottedImageOrder')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ghazi1984/public_html/resources/views/admin/spottedGhazi/spotted.blade.php ENDPATH**/ ?>