     ...
     <div class="page-title">
        <div class="container">
            <header class="entry-header">
                <h1 class="entry-title">Search Products</h1>
                <div class="breadcrumbs">
                    <a href="<?php echo e(route('index')); ?>">Home</a> » <span class="current">Search Products</span>
                </div>
            </header>
        </div>
    </div>
        ...
        <div class="row">
                ...
                <ul>
                    <li class="dropdown">
                        <a class="dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button"
                            ...
                            <?php echo e($categories->first()->parent->cat_name); ?> <span>(<?php echo e($count); ?>)</span>
                        </a>
                ...
                <div class="price-range-filter">
                    ...
                    <form action="<?php echo e(route('productsFilter')); ?>" method="GET">
                        ...
                        <div class="price_slider_wrapper">
                            <input type="range" class="form-control-range" id="priceRange" min="0" max="<?php echo e($maxPriceFromDb); ?>" step="100">
            ...
            <div class="col-lg-9 col-md-12 left-part">
                <div style="font-weight: 700; margin-bottom: 15px;">
                    <a href="<?php echo e(route('index')); ?>" style="color: #8E8E8E">Home / </a><a href="<?php echo e(route('categories', ['id' => $categories->first()->parent->id])); ?>" style="color: #8E8E8E"> <?php echo e($categories->first()->parent->cat_name); ?></a><span class="breadcrumb-last"></span>		
                </div>
                ...
                <div class="pagination-container">
                    <div>
                        <?php echo e($products->appends(request()->query())->links('vendor.pagination.bootstrap-5')); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePriceDisplay() {
                ...
                priceFrom.textContent = formatCurrency(value);
                priceTo.textContent = formatCurrency(max);
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ghazi1984/public_html/resources/views/frontend/search.blade.php ENDPATH**/ ?>