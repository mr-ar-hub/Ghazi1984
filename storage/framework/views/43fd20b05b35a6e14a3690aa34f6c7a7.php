                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title" style="width: 100%;">
                            <h5>Add New Product <a href="<?php echo e(route('allProducts')); ?>" class="btn btn-primary btn-sm float-right"><i class="fas fa-arrow-left"></i> Back</a></h5>
                        </div>  
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('postProducts')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="Enter product name" value="<?php echo e(old('name')); ?>"  class="form-control" />
                            </div>
                            <div class="row">
                                <div class="form-group col-4">
                                    <label>SKU</label>
                                        <input type="text" name="artical_name" placeholder="Article name"  value="<?php echo e(old('artical_name')); ?>" class="form-control" />
                                </div>
                                <div class="form-group col-4">
                                    <label>Price</label>
                                        <input type="number" name="price" placeholder="Rs: " value="<?php echo e(old('price')); ?>" min="0"  class="form-control" />
                                </div>
                                <div class="form-group col-4">
                                    <label>Discount</label>
                                        <input type="text" name="discount" placeholder="%" value="<?php echo e(old('discount')); ?>"  class="form-control" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-4">
                                    <label>Stock</label>
                                        <input type="number" name="stock" placeholder="Add stock" value="<?php echo e(old('stock')); ?>"  class="form-control" />
                                </div>
                                <div class="form-group col-4">
                                    <label>Gender</label>
                                    <div>
                                        <input type="checkbox" name="gender" style="width: 20px; height: 20px; margin-top: 6px;" <?php echo e(old('gender') ? 'checked' : ''); ?>>
                                    </div>
                                </div>
                                <div class="form-group col-4">
                                    <label>Feature</label>
                                    <div>
                                        <input type="radio" name="status" value="1" style="width: 20px; height: 20px; margin-top: 6px;" <?php echo e(old('status') ? 'checked' : ''); ?>>
                                        <label for="hot_sale"style="margin-right: 15px;">Hot Sale</label>
                                        <input type="radio" name="status" value="0" style="width: 20px; height: 20px; margin-top: 6px;" <?php echo e(old('status') ? 'checked' : ''); ?>>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor1" placeholder="Enter description of product" name="description"><?php echo e(old('description')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="editor2">Product Short Description</label>
                                <textarea id="editor2" placeholder="Enter short description of product" name="short_description"><?php echo e(old('short_description')); ?></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12 mt-2">
                                    ...
                                    <a href="<?php echo e(route('addProducts')); ?>" class="btn btn-danger" style="float: right; padding: 5px 50px;">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ghazi1984/public_html/resources/views/admin/products/addProduct.blade.php ENDPATH**/ ?>